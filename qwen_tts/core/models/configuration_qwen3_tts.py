...
class Qwen3TTSConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # Emotion conditioning (project-local extension; absent in upstream config.json -> defaults).
        # use_emotion_projector controls module instantiation in Qwen3TTSForConditionalGeneration.
        self.emotion_dim = emotion_dim
        self.use_emotion_projector = use_emotion_projector
